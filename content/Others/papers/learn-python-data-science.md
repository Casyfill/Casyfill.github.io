...
Date: 2018-01-01
Slug: learn-python-data-science
Subtitle: Packt, 2018
...
<div class="marginnote"><img src="/static/book/simulations.png" alt="Simulating Animal Population. Grid of Monte Carlo simulation plots in blue and red.">
<strong>Simulating Animal Population with Monte Carlo.</strong> From the modeling chapters — many draws, one question.</div>

<div class="marginnote"><img src="/static/book/big_data_map.png" alt="Point map of NYC 311 calls by source on a black background.">
<strong>Years of 311 calls in NYC, by source.</strong> Visualizing big data on the map — a separate skill and a specialized set of tools.</div>
...
<!-- <div class="marginnote"><img src="/static/book/map.png" alt="Bubble map of WWII battle locations across Europe, colored and sized by campaign.">
