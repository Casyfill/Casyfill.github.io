...
<div class="marginnote"><img src="/static/presentations_talks/2017_geo_nyc/se_ads_before.png" alt="A StreetEasy 'Find your place' subway ad: a building in cutaway with floors labeled hint of garbage, aroma of garbage, smell of garbage.">
...
<!-- YEAR CHECK: images live in static/presentations_talks/2017_geo_nyc, but this page says 2018. Confirm the talk year and I'll fix the date + listings. -->

A talk at GeoNYC, New York's geospatial meetup, hosted that night by [Carto](https://carto.com/). I was about a year into StreetEasy, whose pitch then was that it helped you find what you were *actually* looking for, not just scroll an endless list — search you could shape to your own sense of the city. Custom boundaries were the literal version of that: find your spot, then look only there.
...
<div class="marginnote"><img src="/static/presentations_talks/2017_geo_nyc/custom_boundary_tool.png" alt="StreetEasy's 'Create a Custom Boundary' tool: a polygon being drawn over a Manhattan street map inside the search interface.">
...
<figure><img src="/static/presentations_talks/2017_geo_nyc/overall.png" alt="All ~40,000 custom search boundaries over New York City, rendered as a glowing density map; Manhattan blazes and the boroughs' structure emerges.">
...
<figure><img src="/static/presentations_talks/2017_geo_nyc/details.png" alt="The density map annotated: boxes mark a large boundary reaching toward New Jersey and a bright cluster at Forest Hills, with an arrow labeling the bright lines as highways and roads.">
...
<div class="marginnote"><img src="/static/presentations_talks/2017_geo_nyc/walkable.png" alt="Density map of boundaries named 'walkable,' scattered across the city as rough circular shapes.">
...
<!-- <div class="marginnote"><img src="/static/presentations_talks/2017_geo_nyc/prospect_park.png" alt="Density map of custom boundaries drawn around Prospect Park, Brooklyn.">
<strong>Prospect Park.</strong> Boundaries drawn around the park.</div>


<div class="marginnote"><img src="/static/presentations_talks/2017_geo_nyc/equinox.png" alt="Density map of custom boundaries near Equinox gym locations, scattered across Manhattan.">
...
<div class="marginnote"><img src="/static/presentations_talks/2017_geo_nyc/forest_hill.png" alt="Density map of custom boundaries in Forest Hills, Queens, forming two distinct clusters.">
...
<figure><img src="/static/presentations_talks/2017_geo_nyc/forest_hill_photo.png" alt="Aerial view of Forest Hills: low-rise houses with gardens on one side, denser blocks on the other, divided by a rail line and highway corridor.">
...
<!-- TODO: no over-time / Bronx slide was in the folder — add the density-over-time animation (or a still) here if you want to keep this beat. -->

<div class="marginnote"><img src="/static/presentations_talks/2017_geo_nyc/bronx.png" alt="Density of custom boundaries for Bronx, over time.">
<strong>Two clusters, one name.</strong>Density of custom boundaries for Bronx, over time.</div>
...
<div class="marginnote"><img src="/static/presentations_talks/2017_geo_nyc/ads_later.jpeg" alt="A StreetEasy subway ad: a stylized map of Tribeca with the line 'places where I can still say I live in Tribeca,' and 'Find your place.'">
