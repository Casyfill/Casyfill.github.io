...
**MosPlus** is a forked version of Chris Wong's awesome [PlutoPlus](http://chriswhong.github.io/plutoplus/) project, built using open footprints for Moscow (Russia).
...
> Note: FYI, There is a separate, not-exactly-opensourced yet invaluable dataset in the wild, **data for ALL Buildings in Russia** including address, year, type, number of units and floors - so pretty similar to *Pluto*, originated on *reforma-zkh* website. It was since removed, but can be found on the internet.
