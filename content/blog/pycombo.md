...
*How I turned a research C++ algorithm into something anyone can `pip install` — and what a decade of maintaining it taught me about shipping software that lasts.*
...
with $L_c$ = edges inside community $c$, $k_c$ = total degree of its nodes, and $m$ = total edges — the fraction of edges falling inside communities, minus what you'd expect at random.
...
![Zachary's Karate Club, partitioned by Combo (Q = 0.4198, 4 communities)]({static}/static/blog/1_karate_combo.png)
...
- pyCombo (this package): [https://github.com/Casyfill/pyCombo](https://github.com/Casyfill/pyCombo) · `pip install pycombo`
